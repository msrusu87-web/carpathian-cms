    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('simple.login.post') }}">
            ...
            <div class="checkbox-group">
                ...
                <label for="remember" style="margin: 0; font-weight: 400;">Ține-mă minte</label>
            </div>
        ...
        <div class="links">
            <a href="{{ route('register') }}">Nu ai cont? Înregistrează-te</a>
            <br><br>
            <a href="{{ url('/') }}">← Înapoi la pagina principală</a>
        </div>
    </div>
</body>
</html>
