<div class="space-y-6">
    ...
    <div class="bg-gray-50 rounded-lg p-4">
        <div class="flex items-start justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">{{ __('Version') }}: {{ $template->version }} | {{ __('Author') }}: {{ $template->author }}</p>
    ...
    <div>
        <h4 class="text-sm font-semibold text-gray-700 mb-3">🎨 {{ __('Color Palette') }}</h4>
    ...
    <div>
        <h4 class="text-sm font-semibold text-gray-700 mb-3">✍️ {{ __('Typography') }}</h4>
        <div class="bg-white rounded-lg border border-gray-200 p-4 space-y-2">
            <div class="flex justify-between items-center">
                <span class="text-sm text-gray-600">{{ __('Primary Font') }}:</span>
    ...
    <div>
        <h4 class="text-sm font-semibold text-gray-700 mb-3">✨ {{ __('Features') }}</h4>
    ...
    {{-- Preview Sample --}}
    <div>
        <h4 class="text-sm font-semibold text-gray-700 mb-3">👀 {{ __('Style Preview') }}</h4>
        <div class="bg-white rounded-lg border-2 border-gray-200 p-6 space-y-4" 
            ...
            <div class="space-y-3">
                ...
                <p class="text-sm leading-relaxed" style="color: {{ $colors['text_secondary'] ?? '#6b7280' }}">
                    {{ __('This is how your content will look with this template.') }}
                </p>
                
                {{-- Card Sample --}}
                <div class="grid grid-cols-3 gap-3 mt-4">
                    @foreach([__('Feature 1'), __('Feature 2'), __('Feature 3')] as $feature)
    ...
    <div class="flex items-center justify-between pt-4 border-t">
        <p class="text-sm text-gray-500">
            {{ __('Like what you see? Close this preview and click "Activate" to use this template.') }}
        </p>
