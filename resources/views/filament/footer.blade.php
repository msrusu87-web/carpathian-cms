<div class="fi-footer flex items-center justify-center gap-x-4 py-4 text-sm">
    <div class="flex items-center gap-x-4">
        ...
        <a 
            href="https://github.com/msrusu87-web/carpathian-cms" 
            target="_blank" 
            rel="noopener noreferrer"
            class="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200 transition flex items-center gap-x-1"
        >
        ...
        <a 
            href="https://github.com/msrusu87-web/carpathian-cms/tree/main/docs" 
            target="_blank" 
            rel="noopener noreferrer"
            class="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200 transition flex items-center gap-x-1"
        >
